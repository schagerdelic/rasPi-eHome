...
try:
    ...
    GPIO.setup(3, GPIO.OUT) #gruenes led, 3 pin von oben, innere Reihe
except:
    print ("MON no root - no LEDs")
...
while 1:
        ...
        try:
                ...
                try:
                    __settings__ = eHomeSettings.eHomeSettings("//var//www//html//eHome//eHomeSettings.json")
                except Exception, err:
        ...
        for i in range(1,DELAY):
            ...
            #ch = msvcrt.getch()
            try:
                GPIO.output(3, GPIO.LOW) # grünes LED an, 3 pin von oben innen, GPIO 03
                time.sleep(0.1)
